---
name: nexus-multi-agent-platform
description: >
  Use this guide whenever the project is being extended into a real multi-agent
  platform, orchestration workspace, or team-simulation product. It applies to
  generic LLM backends, local simulation mode, and future backend adapters.
---
