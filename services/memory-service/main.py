...
MAX_MEMORY_CONTENT_LENGTH = int(os.getenv("MAX_MEMORY_CONTENT_LENGTH", "20000"))
MAX_MEMORY_METADATA_BYTES = int(os.getenv("MAX_MEMORY_METADATA_BYTES", "12000"))
MAX_MEMORY_TOP_K = int(os.getenv("MAX_MEMORY_TOP_K", "25"))
MAX_SHORT_TERM_RECORDS = int(os.getenv("MAX_SHORT_TERM_RECORDS", "200"))
